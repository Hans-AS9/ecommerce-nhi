    ...
    <div class="container container-lg">
        ...
        <div class="row g-12">
            <div class="custom-2xl:w-8/12 flex-grow-0 flex-shrink-0 basis-auto">
                <div class="row g-4">
                    <div class="lg:w-6/12 flex-grow-0 flex-shrink-0 basis-auto" data-aos="fade-up" data-aos-duration="200">
                        <div class="product-card style-two h-full p-8 border border-gray-100 hover-border-main-600 rounded-16 relative transition-2 flex items-center gap-16">
                            <div class="">
                                ...
                                <a href="{{ url('product-details') }}" class="product-card__thumb flex items-center justify-center">
                                    <img src="{{ asset('frontend/assets/images/thumbs/best-sell1.png') }}" alt="C-500 Antioxidant Protect Dietary Supplement">
                                </a>
                            ...
                            <div class="product-card__content">
                                ...
                                <h6 class="title text-lg font-[600] mt-12 mb-8">
                                    <a href="{{ url('product-details') }}" class="link text-line-2">C-500 Antioxidant Protect Dietary Supplement</a>
                                </h6>
                                ...
                                <div class="mt-12">
                                    <div class="progress w-full bg-color-three rounded-[50rem] h-4" role="progressbar" aria-label="Basic example" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100">
                    ...
                    <div class="lg:w-6/12 flex-grow-0 flex-shrink-0 basis-auto" data-aos="fade-up" data-aos-duration="400">
                        <div class="product-card style-two h-full p-8 border border-gray-100 hover-border-main-600 rounded-16 relative transition-2 flex items-center gap-16">
                            <div class="">
                                <span class="product-card__badge bg-danger-600 px-8 py-4 text-sm text-white">Sale 50%</span>
                                <a href="{{ url('product-details') }}" class="product-card__thumb flex items-center justify-center">
                                    <img src="{{ asset('frontend/assets/images/thumbs/best-sell2.png') }}" alt="Marcel's Modern Pantry Almond Unsweetened">
                                </a>
                    ...
                    <div class="lg:w-6/12 flex-grow-0 flex-shrink-0 basis-auto" data-aos="fade-up" data-aos-duration="600">
                        <div class="product-card style-two h-full p-8 border border-gray-100 hover-border-main-600 rounded-16 relative transition-2 flex items-center gap-16">
                            <div class="">
                                <span class="product-card__badge bg-danger-600 px-8 py-4 text-sm text-white">Sale 50%</span>
                                <a href="{{ url('product-details') }}" class="product-card__thumb flex items-center justify-center">
                                    <img src="{{ asset('frontend/assets/images/thumbs/best-sell3.png') }}" alt="Daily Snacks">
                                </a>
                            ...
                            <div class="product-card__content">
                                ...
                                <h6 class="title text-lg font-[600] mt-12 mb-8">
                                    <a href="{{ url('product-details') }}" class="link text-line-2">Daily Snacks</a>
                                </h6>
                                <div class="flex items-center gap-4">
                                    <span class="text-main-600 text-md flex"><i class="ph-fill ph-storefront"></i></span>
                                    <span class="text-gray-500 text-xs">By Lucky Supermarket</span>
                    ...
                    <div class="lg:w-6/12 flex-grow-0 flex-shrink-0 basis-auto" data-aos="fade-up" data-aos-duration="800">
                        <div class="product-card style-two h-full p-8 border border-gray-100 hover-border-main-600 rounded-16 relative transition-2 flex items-center gap-16">
                            <div class="">
                                <span class="product-card__badge bg-danger-600 px-8 py-4 text-sm text-white">Sale 50%</span>
                                <a href="{{ url('product-details') }}" class="product-card__thumb flex items-center justify-center">
